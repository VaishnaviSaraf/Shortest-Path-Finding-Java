// DS MINI PROJECT T1 AKANKSHA (),AAHANA(UIT2021844) ,VAISHNAVI(UIT2021860) ,ISHA(UIT2021848)
...
// from the group of vertices that has not been included yet
    static final int totalVertex = 5;
    int minimumDistance(int distance[], Boolean spSet[])
    {
// Initialize min value
        // compares distances between 2 nodes
...
// creating an object of the class DijkstraExample
        ...
        int t;
        System.out.println("Enter no. from which you want to find shortest distance for all destination numbers : ");
        t=sc.nextInt();
        obj.dijkstra(grph, t);
    }
}
...
// output:
// Enter no. from which you want to find shortest distance for all destination numbers :
//0
...
//To 2 the shortest distance is: 6
//To 3 the shortest distance is: 12
//To 4 the shortest distance is: 8
//
